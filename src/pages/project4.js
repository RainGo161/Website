  ...
  return (
    <div>
      ...
      <div className="w-full -translate-y-14">
        <img className="h-full px-0 py-0 w-[100vw] relative z-0" src="./door.png"></img>
      </div>
      ...
      <div className="mx-auto max-w-7xl mt-10 px-4 py-2 pb-[12rem]">
        <motion.h1 ref={firstRef} initial={{ scale: 1.1, opacity: 0 }} animate={inView1 ? { scale: 1, opacity: 1 } : {}} transition={{ delay: 0, duration: 0.6, ease: "easeInOut" }} className="md:text-[64px] text-[24px] max-w-3xl font-medium md:tracking-[-3px] md:leading-[70px] text-[#222222] relative z-10">
          Интернет-магазин "Новые двери"
        </motion.h1>

        <motion.img ref={secondRef} initial={{ scale: 1.1, opacity: 0 }} animate={inView2 ? { scale: 1, opacity: 1 } : {}} transition={{ delay: 0.2, duration: 0.6, ease: "easeInOut" }} className="h-full md:rounded-[40px] rounded-[20px] md:mt-[10rem] mt-[4rem] px-0 py-0 w-[100vw] relative" src="./door.png"></motion.img>
