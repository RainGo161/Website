  ...
  return (
    <div>
      ...
      <div className="w-full -translate-y-14">
        <img className="h-full px-0 py-0 w-[100vw] relative z-0" src="./stuff_master.png"></img>
      </div>
      ...
      <div className="mx-auto max-w-7xl mt-10 px-4 py-2 pb-[12rem]">
        ...
        <motion.img ref={secondRef} initial={{ scale: 1.1, opacity: 0 }} animate={inView2 ? { scale: 1, opacity: 1 } : {}} transition={{ delay: 0.2, duration: 0.6, ease: "easeInOut" }} className="h-full md:rounded-[40px] rounded-[20px] md:mt-[10rem] mt-[4rem] px-0 py-0 w-[100vw] relative" src="./stuff-1.jpg"></motion.img>
        ...
        <motion.p ref={fourthRef} initial={{ x: -70, opacity: 0 }} animate={inView4 ? { x: 0, opacity: 1 } : {}} transition={{ delay: 0.1, duration: 0.5, ease: "easeInOut" }} className="md:ml-3 max-w-3xl font-medium md:text-[24px] text-[16px] md:mt-[8rem] mt-[2rem]">Требуется разработать интернет-магазин под названием "Stuff". Магазин будет предоставлять широкий ассортимент товаров, доступных для покупки онлайн. Целью проекта является использование максимально современных технологий для создания удобного и функционального веб-приложения.</motion.p>
        ...
        <div className="grid grid-cols-2 gap-5 md:mt-[8rem] mt-[3rem]">
          <motion.img
            ...
            transition={{ delay: 0.1, duration: 0.5, ease: "easeInOut" }} className="px-0 py-0 relative md:rounded-[40px] rounded-[20px]" src="./stuff-2.jpg" alt="Изображение 2"></motion.img>
        </div>

        <div className="grid grid-cols-3 gap-5 mt-[1.25rem]">
          <motion.img ref={eighthRef} initial={{ scale: 1.1, opacity: 0 }} animate={inView8 ? { scale: 1, opacity: 1 } : {}} transition={{ delay: 0, duration: 0.6, ease: "easeInOut" }} className="px-0 py-0 relative md:rounded-[40px] rounded-[20px]" src="./stuff-3.jpg" alt="Изображение 2"></motion.img>
        </div>
